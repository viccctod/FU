...
Original file is located at
    https://colab.research.google.com/drive/1Y0vo28-adkn1Py_fYeXVaQOF3N9ujkx9
"""
...
def PrintMatrix(matrix):
    for i in range(len(matrix)):
        print(matrix[i])
# Ввод пользоваттеля
startWith = int(input('Стартовый город: '))
...
#выбор старта с определенного города
result3 = []
index = 0

for i in range(0, len(result2), 1):
  if (result2[i] == startWith):
    index = i
    break

for i in range(index, len(result2), 1):
  result3.append(result2[i])

for i in range(0, index, 1):
  result3.append(result2[i])

result3.append(startWith)

print('полученный путь: ', result3)
